...
| `vitest` | 5.0.0 | MIT | The test runner the changed-tests analyzer drives, and the copy its own tests run against. Resolved from the repository under review at run time. |
