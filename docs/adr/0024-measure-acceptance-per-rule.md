...
- **Positive:** the same measurement covers the model lane, whose categories are a closed set for
  exactly this reason (ADR-0022). A taste category nobody acts on is visible within weeks.
